        ...
        <div>
          <header className="App-header">
            <div class="row justify-content-center">
              <div class="WE-ARE col-5">WE ARE</div>
            </div>
        ...
        <div class="container my-5">
          <blockquote class="blockquote HMW">
            <p class="mb-0 ml-3 my-auto">
              How might we help companies to find a social program that matches
              their employees goals with their own?
            </p>
          </blockquote>
        </div>
        ...
        <div class="container my-5">
          ...
          <div class="card-deck mt-5">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a
                  href="https://www.linkedin.com/in/thomas-stanner-27180a154/"
                  class="card-link"
                >
                  Linkedin
                </a>
                <a
                  href="https://www.xing.com/profile/Thomas_Stanner"
                  class="card-link"
                >
                  XING
                </a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Product Manager</p>
                <a
                  href="https://www.linkedin.com/in/luis-kentzler-68409522/"
                  class="card-link"
                >
                  Linkedin
                </a>
                <a href="https://github.com/kentzler" class="card-link">
                  GitHub
                </a>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a
                  href="https://www.linkedin.com/in/chingyunchen/"
                  class="card-link"
                >
                  Linkedin
                </a>
                <a href="https://www.chingyunchen.com/" class="card-link">
                  Portfolio
                </a>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a
                  href="https://www.linkedin.com/in/diana-barrios/"
                  class="card-link"
                >
                  Linkedin
                </a>
                <a href="https://github.com/DianaBarrios" class="card-link">
                  GitHub
                </a>
              </div>
            </div>
          ...
          <div class="card-deck">
            <div class="card About-us">
              <div class="card-body">
                <h1 class="card-title display-4 font-weight-bold">
